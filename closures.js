...
// Inside the return create a publicMethod property that is a function that invokes
// privateMethod. After you create the privateMethod
...
function timeOutCounter() {
  for (var i = 0; i <= 5; i++) {
    ...
    setTimeout(currentValue , i * 1000)
  }
